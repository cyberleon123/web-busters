...
<body style="background-color: rgb(253, 169, 74);">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" style="font-size: 20px; margin-left: 25px; font-style: bold;" href="dealerprofile.php">View Profile</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container">
        <center>
            <h2 class="three">Drivers Availbale For Your Searched Route</h2>
        </center>
    </div>
<br>
<section id="table">
            ...
            <table class="table table-sm mt-3" style="width: 100%">
                <thead>
                    <tr>
                        ...
                        <th scope="col">Driver Experience</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <th scope="row" class="white"><?php echo $driverid; ?></th>
                        <td class="white"><?php echo $drivername; ?></td>
                        <td class="white"><?php echo $_SESSION['driveremail']; ?></td>
                        <td class="white"><?php echo $driverphone; ?></td>
                        <td class="white"><?php echo $driverage; ?></td>
                        <td class="white"><?php echo $truck_no; ?></td>
                        <td class="white"><?php echo $truck_cap; ?></td>
                        <td class="white"><?php echo $trans_name; ?></td>
                        <td class="white"><?php echo $driver_exp; ?></td>
                        <td class="white">
                            <form action="book.php" method="post">
                                <button type="submit" name="submit" class="btn btn-primary">Book Driver</button>
                            </form>
                        </td>
                    </tr>
                </tbody>
