...
<body style="background-color: rgb(253, 169, 74);">
    ...
    <div class="fluid-container" style="background-color: rgb(3, 41, 77); height: 50px; color:rgb(223, 222, 222); font-family: serif;">
        <center>
            <div>
                <h1>Welcome <?php echo 'Dealer' .' '. $name ;?></h1>
            </div>
        </center>
    </div>
    ...
    <div class="container">
        <center>
            <h1 class="three">Search For The Drivers</h1>
        </center>
    </div>
    <br><br><br>
    <div class="container">
        <form action="driversearch1.php" method="post">
            <ul class="list-group list-group-flush">
                <li class="list-group-item">
                    <div class="row">
                        ...
                        <div class="form-group col-sm-2 md-2" style="margin-top: 70px;">
                            <button type="submit" name="submit" class="btn btn-primary">Search Drivers</button>
                        </div>
                    </div>
                </li>
            <ul>
